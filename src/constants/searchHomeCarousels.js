...
export const SEARCH_HOME_CAROUSELS = [
  {
    ...
    variant: 'search',
    items: [
      { id: 'rs-1', label: 'stadium rock anthem for live sports broadcast', subtitle: '30 minutes ago' },
      { id: 'rs-2', label: 'milan olympics broadcast package music', subtitle: '2 hours ago' },
      { id: 'rs-3', label: 'promo 30 second uplifting corporate', subtitle: '1 day ago' },
      { id: 'rs-4', label: 'acoustic indie singer songwriter', subtitle: '2 days ago' },
      { id: 'rs-5', label: 'instrumental only no vocals', subtitle: '5 days ago' },
      { id: 'rs-6', label: 'uplifting orchestral build to climax', subtitle: '1 week ago' },
      { id: 'rs-7', label: 'epic trailer music hybrid orchestral', subtitle: '2 weeks ago' },
      { id: 'rs-8', label: 'news broadcast bed tension underscore', subtitle: '1 month ago' },
    ],
  },
  {
    id: 'recently-played',
